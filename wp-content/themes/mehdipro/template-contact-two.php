				...
				<article class="post row animated fadeInUpBig">
				    ...
				    <div class="inner-pad">
					    ...
					    <div class="col span_7 first">
						    ...
						    <form id="contactform" class="formular marT60" method="post">
				                <fieldset>
					    ...
					    <div id="sidebar" class="col span_5">

						    <?php if($ct_options['ct_contact_map'] == "Yes") {
								contact_us_map();
							} ?>

				            <div id="sidebar-inner" class="contact-details marT40">
				                <ul>
				                    <?php if($address != '') { ?>
