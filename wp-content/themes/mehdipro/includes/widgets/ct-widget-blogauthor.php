...
class ct_BlogAuthorInfo extends WP_Widget {
   ...
   function widget($args, $instance) {  
	...
	?>
		...
		<span class="<?php echo esc_attr($avatar_align); ?>"><?php if ( $custom_email ) echo get_avatar( $custom_email, $size = $avatar_size ); ?></span>
		<p><?php echo $bio; ?></p>
		<?php if ( $read_more_url ) echo '<p class="right"><a class="read-more" href="' . esc_attr($read_more_url) . '">' . esc_attr($read_more_text) . '<em>&rarr;</em></a></p>'; ?>
