...
class ct_flickr extends WP_Widget {
	...
	function widget($args, $instance) {  
        ...
        <?php echo $after_title; ?>
            ...
            <script type="text/javascript" src="http://www.flickr.com/badge_code_v2.gne?count=<?php echo esc_attr($number); ?>&amp;display=<?php echo esc_attr($sorting); ?>&amp;&amp;layout=x&amp;source=<?php echo $type; ?>&amp;<?php echo $type; ?>=<?php echo esc_attr($id); ?>&amp;size=<?php echo esc_attr($size); ?>"></script>        
