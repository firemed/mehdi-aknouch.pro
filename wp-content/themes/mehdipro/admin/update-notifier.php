...
define( 'NOTIFIER_THEME_NAME', 'WP Longshore' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'longshore' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', 'http://wp.contempographicdesign.com/wp_longshore/changelog/notifier.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
